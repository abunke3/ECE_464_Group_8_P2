...
def main():
    ...
    while True:
        batchSize = 1
        print("\nUse 1 as batch size? Otherwise enter desired batchSize, 1-10:\n")
        userInput = input()
        if userInput =="":
            print(" \nYour batch size is: ", batchSize)
            break
        else: 
            ...
            if(batchSize >= 1 & batchSize <= 10):
                ...
                print("\nInteger Value not Valid. Enter a valid integer, 1-10")
    ...
    writer.writerow(["Batch #", "A", "B", "C", "D", "E", "seed = " + str(seedVal), "batch size = " + str(batchSize)])
